...
const ifos: Ifo[] = [
  {
    id: 'far',
    address: '0x256fecb295231de5b33b50ca9ae331b56234543d',
    isActive: true,
    name: 'DLF SWAP ',
    ...
    raiseAmount: '$800,000',
    cakeToBurn: '$400,000',
    projectSiteUrl: 'https://DLF SWAP.io/',
    currency: 'DLF-BNB LP',
    currencyAddress: '0x4035851f36e3fd0064009cd39677bed7ee30b3c8',
    tokenDecimals: 18,
    tokenSymbol: 'DLF',
    releaseBlockNumber: 5294922,
