...
import { Image, Card, CardBody } from 'dlf-ui-kit'
        ...
        <CardBody>
          <StyledCardContentInner>
            ...
            <RabbitRow>
              <RabbitBox>
                <CardImageFirst>
                  <Image src="" alt="Number 1" width={200} height={150} responsive />
                </CardImageFirst>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="" alt="Number 2" width={200} height={150} responsive />
                </CardImage>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="" alt="Number 3" width={200} height={150} responsive />
                </CardImage>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="" alt="Number 4" width={200} height={150} responsive />
                </CardImage>
              </RabbitBox>
            </RabbitRow>
            <RabbitRowSmall>
