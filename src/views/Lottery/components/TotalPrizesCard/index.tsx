...
import { Heading, Card, CardBody, CardFooter, Text, PancakeRoundIcon, Flex, Skeleton } from 'dlf-ui-kit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} DLF</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
