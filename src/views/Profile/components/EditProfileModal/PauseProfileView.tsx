...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from 'dlf-ui-kit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {TranslateString(999, `Cost to reactivate in future: ${getBalanceNumber(numberCakeToReactivate)} DLF`)}
      </Text>
