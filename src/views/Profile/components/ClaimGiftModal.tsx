...
import { Modal, Text, InjectedModalProps, Button, AutoRenewIcon } from 'dlf-ui-kit'
  ...
  return (
    <Modal title={TranslateString(999, 'Claim your Gift!')} onDismiss={onDismiss}>
      <div style={{ maxWidth: '640px' }}>
        ...
        <Text as="p">
          {TranslateString(999, "To make it up to you, we'll refund you the full 4 DLF it cost to make your bunny.")}
        </Text>
        <Text as="p" mb="8px">
          {TranslateString(
            999,
        ...
        <Button
          ...
          disabled={!canClaim}
        >
          {TranslateString(999, 'Claim Your DLF')}
        </Button>
      </div>
    </Modal>
  )
