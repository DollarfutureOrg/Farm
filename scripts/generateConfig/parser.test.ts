...
describe('Parser', () => {
  ...
  const inputFarm = [
    {
      ...
      pid: 0,
      lp_symbol: 'DLF',
      lp_mainnet_address: '0x3123111edf985abe2f9c711cdc9cbfd4d3868c53',
      token: {
        _id: '5ffd7e79361bff0009cc8189',
        decimals: 18,
        name: 'SYRUP',
        symbol: 'SYRUP',
        mainnet_address: '0x3123111edf985abe2f9c711cdc9cbfd4d3868c53',
  ...
  it('DLFM - return the correct value', () => {
    const outPut = [
      {
        pid: 0,
        lpSymbol: 'DLF',
        lpAddresses: '0x3123111edf985abe2f9c711cdc9cbfd4d3868c53',
        tokenSymbol: 'SYRUP',
        tokenAddresses: '0x3123111edf985abe2f9c711cdc9cbfd4d3868c53',
    ...
    expect(getFormattedData(SettingsType.DLFM, inputFarm)).toStrictEqual(outPut)
  })
})
